...
namespace DTcms.Model
{
    ...
    public partial class article_attribute_field
    {
        ...
        private string _BindSQLTitle;
        private string _BindSQLValue;
        /// <summary>
        /// 自增ID
        /// </summary>
        public int id
        ...
        /// BindSQLTitle
        /// </summary>
        public string BindSQLTitle
        {
            set { _BindSQLTitle = value; }
            get { return _BindSQLTitle; }
        }
        /// <summary>
        /// BindSQLValue
        /// </summary>
        public string BindSQLValue
        {
            set { _BindSQLValue = value; }
            get { return _BindSQLValue; }
        }
        #endregion
    }
}