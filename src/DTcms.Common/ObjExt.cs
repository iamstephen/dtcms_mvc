...
namespace DTcms.Common
{
    ...
    public static class ObjExt
    {
        ...
        /// <returns></returns>
        public static string ToDateTimeFormat(this string dateFormat)
        {
            if (dateFormat.ToString() == "yyyy-mm-dd hh:ii:ss")
            {
                return "yyyy-MM-dd HH:mm:ss";
            }
            if (dateFormat.ToString() == "yyyy-mm-dd")
            {
                return "yyyy-MM-dd";
            }
        ...
        /// <param name="dateFormat">时间格式字符串</param>
        /// <returns></returns>
        public static string ToDateTimeShow(this string dateFormat)
        {
            if (dateFormat.ToString() == "yyyy-MM-dd HH:mm:ss")
            {
