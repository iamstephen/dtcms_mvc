    ...
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          ...
          <li style="display:none"><asp:LinkButton ID="lbtnUnLock" runat="server" OnClientClick="return ExePostBack('lbtnUnLock','审核后前台将显示该信息，确定继续吗？');" onclick="lbtnUnLock_Click"><i class="iconfont icon-survey"></i><span>审核</span></asp:LinkButton></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="reply.aspx?id=<%#Eval("id")%>"><%--回复--%>查看</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
